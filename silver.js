...
const botaoßeiniciar = document. queryselector("&botaoReiniciar');
...
// Math.random() gera un número entre 0 (inclusive) e 1 (exclusive)
...
function iniciarJogo() {
    // Gerar um novo número secreto (entre 1 e 100)
    numeroSecreto = Math.floor(Math.random() * 100) + 1; // Gera um número entre 0 (inclusive) e 1 (exclusive)
